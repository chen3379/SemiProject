...
function openCustomConfirm(msg, callback){
  ...
  setTimeout(()=>document.querySelector(".btn-confirm-ok").focus(),100);
}
...
document.querySelector(".btn-confirm-ok").onclick = function(){
  closeCustomConfirm(true);
};
document.querySelector(".btn-confirm-cancel").onclick = function(){
  closeCustomConfirm(false);
};

// 키보드
document.addEventListener("keydown", function(e){
  const o=document.getElementById("custom-confirm-overlay");
